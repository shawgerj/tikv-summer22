...
c = canvas(ctype, title='rocksdb-randomfill-throughput-ssd', dimensions=['6.5in', '5in'])
...
axis(drawable=d, title='RocksDB randomfill - Throughput and Stall Percentage SSD', style='x', xtitle='Value size (Bytes)',
