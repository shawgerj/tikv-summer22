...
c = canvas(ctype, title='rocksdb-randomfill-latency-ssd', dimensions=['6.5in', '5in'])
...
axis(drawable=d, title='RocksDB randomfill - Latency SSD', style='x', xtitle='Value size (Bytes)',
